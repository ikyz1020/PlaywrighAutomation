...
- Name: tests\api.spec.js >> Get User - Unauthorized - 401
...
```ts
  ...
  86 | // });
  87 | 
  88 | // 401 Negative Test - No Authentication
  89 | test('Get User - Unauthorized - 401', async ({ request }) => {
  90 | 
  91 |     const response = await request.get(
  92 |         'https://api-testing-postman.vercel.app/api/v1/users'
  93 |     );
  94 | 
