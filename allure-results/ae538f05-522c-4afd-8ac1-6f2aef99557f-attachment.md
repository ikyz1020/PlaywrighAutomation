...
- Name: tests\api.spec.js >> Delete User Account - Unauthorized - 401
- Location: tests\api.spec.js:90:5
...
```ts
  ...
  32  | // data:{
  33  | //   "fullname": "Asim Ali",
  34  | //   "email": "test@example.com",
  35  | //   "username": "asimali0123",
  36  | //   "password": "asimali12356"
  37  | // }
  38  | 
  39  | // });
  ...
  51  | //         {
  52  | //             data: {
  53  | //                 fullname: "Asim Ali",
  54  | //                 email: "asim987654321@example.com",
  55  | //                 username: "asim987654321",
  56  | //                 password: "asimali12356"
  57  | //             }
  58  | //         }
  59  | //     );
  60  | 
  ...
  86  | // });
  87  | 
  88  | // Negative Test - Delete User Without Authentication
  89  | // Negative Test - Delete User Without Authentication
  90  | test('Delete User Account - Unauthorized - 401', async ({ request }) => {
  91  | 
  92  |     const response = await request.delete(
  93  |         'https://api-testing-postman.vercel.app/api/v1/users/delete-account'
  94  |     );
  95  | 
> 96  |     const responseBody = await response.json();
      |                          ^ SyntaxError: Unexpected token 'A', "A server e"... is not valid JSON
  97  | 
  98  |     console.log('Status:', response.status());
  99  |     console.log('Response:', responseBody);
  100 | 
  101 |     expect(response.status()).toBe(401);
  102 |     expect(responseBody.success).toBe(false);
  103 |     expect(responseBody.message).toBe('Unauthorized Access');
  104 | });
```